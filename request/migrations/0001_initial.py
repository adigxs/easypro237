    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SMALL INSTANCE', 'SMALL INSTANCE'), ('HIGH INSTANCE', 'HIGH INSTANCE')], db_index=True, max_length=150)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('iso2', 'iso3'), ('name', 'iso2')},
            },
        ),
        migrations.CreateModel(
            name='Agent',
        ...
        migrations.AddField(
            model_name='court',
            name='municipality',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='request.municipality'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rob', models.ForeignKey(blank=True, help_text='Region of birth', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rob', to='request.region')),
                ('ror', models.ForeignKey(blank=True, help_text='Region of residency', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ror', to='request.region')),
            ],
            options={
                'unique_together': {('format', 'ror', 'rob'), ('ror', 'rob', 'cost')},
            },
        ),
        migrations.CreateModel(
            name='Request',
            fields=[
                ...
                ('user_id_scan', models.FileField(blank=True, db_index=True, help_text='ID card scan of client requesting the service', null=True, upload_to='SCANS')),
                ('user_passport', models.FileField(blank=True, db_index=True, help_text='Passport of client requesting the service', null=True, upload_to='SCANS')),
                ...
                ('user_email', models.EmailField(db_index=True, help_text='Email of client requesting the service', max_length=150)),
                ...
                ('user_cob', models.ForeignKey(blank=True, help_text='Country of birth', max_length=150, null=True, on_delete=django.db.models.deletion.SET_NULL, to='request.country')),
        ...
        migrations.AlterUniqueTogether(
            name='court',
            unique_together={('name', 'municipality'), ('name', 'region'), ('region', 'municipality')},
        ),
    ]
